            ...
            for file in files:
                zipf.write(os.path.join(root, file),
                           os.path.relpath(os.path.join(root, file),
                                           os.path.join(child_theme_dir, '..')))

    # Limpar arquivos temporários
    # Clean up temporary files
    os.system(f'rm -rf {extracted_path} {child_theme_dir}')
...
child_theme_zip_path = create_wordpress_child_theme(parent_theme_zip, child_theme_name, output_dir)
